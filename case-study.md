...
> **Wessam — replace this section with your real numbers.** Pick the ones you can defend honestly:
> - candidates processed per run / per week
> - manual shortlisting time eliminated (e.g. "X hours/role → minutes")
> - number of roles / clients served
> - outreach volume handled without rate-limit incidents
> - any reduction in time-to-shortlist
>
> A non-technical hiring manager will remember one concrete number far longer than any architecture detail. Make it true and make it specific.
